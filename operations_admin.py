...
def operations_admin_page(complaints_collection):
    st.title("Operations Department Admin Dashboard")

    # Fetch complaints assigned to the Operations Department
    ...
    if complaints:
        ...
        st.write("No complaints assigned to the Operations Department.")
