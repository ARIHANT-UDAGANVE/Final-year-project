...
def customer_service_admin_page(complaints_collection):
    st.title("Customer Service Department Admin Dashboard")

    # Fetch complaints assigned to the Customer Service Department
    ...
    if complaints:
        ...
        st.write("No complaints assigned to the Customer Service Department.")
